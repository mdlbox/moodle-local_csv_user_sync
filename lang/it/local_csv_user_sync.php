...
$string['privacy:metadata:local_cus_log'] = 'Memorizza i log di esecuzione della sincronizzazione CSV.';
$string['privacy:metadata:local_cus_log:level'] = 'Livello severita del log.';
$string['privacy:metadata:local_cus_log:message'] = 'Testo del messaggio di log.';
$string['privacy:metadata:local_cus_log:rownum'] = 'Numero riga CSV collegato al log.';
$string['privacy:metadata:local_cus_log:runid'] = 'Identificativo della run di sincronizzazione.';
$string['privacy:metadata:local_cus_log:timecreated'] = 'Timestamp di creazione del log.';
$string['privacy:metadata:local_cus_log:userid'] = 'ID utente referenziato dal log.';
$string['privacy:metadata:local_cus_log:username'] = 'Username referenziato dal log.';
